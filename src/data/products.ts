...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      { id: 'class-0-rubber-foam-insulation', name: 'Class 0 Rubber Foam Insulation' },
    ],
    products: [
      {
        id: 'im-1',
      ...
      },
      {
        id: 'im-2',
        categoryId: 'insulation-tubes',
        subCategoryId: 'class-0-rubber-foam-insulation',
        name: 'Class 0 Rubber Foam Insulation Tube',
        metaTitle: 'Wholesale Class 0 Rubber Foam Insulation Tube | HVACR NET',
        metaDescription: 'Class 0 NBR rubber foam insulation tube, BS476 Part 6 fire rating, density 60-65 kg/m³, OD 6–48 mm, wall 9–19 mm. Black, flexible, low smoke. MOQ 1 pc. Supplier from China.',
        shortDesc: 'Class 0 NBR rubber foam insulation tube with BS476 Part 6 fire rating. Density 60–65 kg/m³, μ≥10000. Black color, flexible closed-cell structure for critical HVAC applications. Flame-retardant, low smoke, and high water vapour resistance.',
        description: 'Our Class 0 rubber foam insulation tube is designed for critical applications where fire safety is paramount. Manufactured from pure NBR (Nitrile Butadiene Rubber) with 60–65 kg/m³ density, this premium insulation tube meets the stringent Class 0 fire rating per BS476 Part 6, making it suitable for data centres, clean rooms, hospitals, and other fire-sensitive environments.\n\nThe closed-cell structure provides excellent thermal insulation while preventing moisture ingress. With water vapour resistance factor μ ≥ 10,000 and thermal conductivity ≤ 0.034 W/(m·K) at 0°C, this product delivers superior performance in demanding applications.',
        features: [
          'Class 0 Fire Rating per BS476 Part 6 — highest fire safety standard for insulation materials',
          'Low Thermal Conductivity — ≤ 0.034 W/(m·K) at 0°C, effective for energy-saving insulation',
          'High Water Vapour Resistance — μ ≥ 10,000, closed-cell structure blocks moisture penetration',
          'Low Water Absorption — ≤ 5% (volume), maintains insulation performance in humid environments',
          'Flexible & Easy to Install — conforms to pipes and fittings without cracking',
          'Wide Compatibility — Fits copper tube OD from 6 mm to 48 mm (1/4" to 1-7/8"), wall thickness 9/13/19 mm',
          'Temperature Range — -40°C to +105°C, suitable for chilled water, refrigerant lines, and hot water',
          'Low Smoke Emission — safe for occupied spaces and critical environments',
        ],
        materialStandard: [
          { label: 'Material', value: 'Pure NBR (Nitrile Butadiene Rubber) elastomeric foam' },
          { label: 'Fire Rating', value: 'Class 0 (BS476 Part 6), B1 (GB 8624)' },
          { label: 'Density', value: '60–65 kg/m³' },
          { label: 'Standard', value: 'BS476 Part 6, GB/T 17794-2021' },
        ...
        specTable: {
          headers: ['Model', 'For Copper Tube OD', 'OD (mm)', 'Wall (mm)', 'Length (m)', 'Color', 'Packing (PCS/bag)'],
          rows: [
            ['ZJ-C0-6×9', '1/4"', '6', '9', '2', 'Black', '180'],
            ['ZJ-C0-10×9', '3/8"', '10', '9', '2', 'Black', '140'],
            ['ZJ-C0-13×9', '1/2"', '13', '9', '2', 'Black', '120'],
            ['ZJ-C0-16×9', '5/8"', '16', '9', '2', 'Black', '100'],
            ['ZJ-C0-19×9', '3/4"', '19', '9', '2', 'Black', '100'],
            ['ZJ-C0-25×9', '1"', '25', '9', '2', 'Black', '80'],
            ['ZJ-C0-32×9', '1-1/4"', '32', '9', '2', 'Black', '60'],
            ['ZJ-C0-43×9', '1-5/8"', '43', '9', '2', 'Black', '50'],
            ['ZJ-C0-48×9', '1-7/8"', '48', '9', '2', 'Black', '50'],
            ['ZJ-C0-6×13', '1/4"', '6', '13', '2', 'Black', '120'],
            ['ZJ-C0-10×13', '3/8"', '10', '13', '2', 'Black', '110'],
            ['ZJ-C0-13×13', '1/2"', '13', '13', '2', 'Black', '100'],
            ['ZJ-C0-16×13', '5/8"', '16', '13', '2', 'Black', '80'],
            ['ZJ-C0-6×19', '1/4"', '6', '19', '2', 'Black', '100'],
            ['ZJ-C0-10×19', '3/8"', '10', '19', '2', 'Black', '80'],
            ['ZJ-C0-13×19', '1/2"', '13', '19', '2', 'Black', '80'],
            ['ZJ-C0-16×19', '5/8"', '16', '19', '2', 'Black', '60'],
            ['ZJ-C0-20×19', '3/4"', '20', '19', '2', 'Black', '60'],
            ['ZJ-C0-22×19', '7/8"', '22', '19', '2', 'Black', '50'],
            ['ZJ-C0-25×19', '1"', '25', '19', '2', 'Black', '40'],
            ['ZJ-C0-28×19', '1-1/8"', '28', '19', '2', 'Black', '35'],
            ['ZJ-C0-34×19', '1-1/4"', '34', '19', '2', 'Black', '30'],
            ['ZJ-C0-38×19', '1-1/2"', '38', '19', '2', 'Black', '30'],
            ['ZJ-C0-43×19', '1-5/8"', '43', '19', '2', 'Black', '25'],
            ['ZJ-C0-48×19', '1-7/8"', '48', '19', '2', 'Black', '25'],
          ],
        },
        applications: 'Data centres, clean rooms, hospitals, laboratories, critical HVAC systems, fire-sensitive applications, commercial buildings with strict fire codes',
        images: [
          'https://static.coze.site/1523302220958247_0-drive/221124540266223586/02-B1%20High%20Density%20-1_1788755764576_1_gam0.jpg?sign=1791261388-c19c230e42-0-64fefe94ec67ea5094ce13580649db12cd940b7604aa8c3644b914e340b7f04e',
          'https://static.coze.site/1523302220958247_0-drive/221124540266223586/02-B1%20High%20Density%20-2_1788755764576_2_0ez1.jpg?sign=1791261388-0e331460de-0-126669027e1d7bf289375184630a960af544e8f857c1e1aa7702d7ba707fc54d',
          'https://static.coze.site/1523302220958247_0-drive/221124540266223586/02-B1%20High%20Density%20-3_1788755764576_3_sifj.png?sign=1791261388-38813776d4-0-a71bf87e85231bcdd1502f3c99a1e732cd73ac6f4e820a30e66d9c578ceef6cf',
          'https://static.coze.site/1523302220958247_0-drive/221124540266223586/02-B1%20High%20Density%20-4_1788755764576_4_ymma.jpg?sign=1791261388-b1115599b1-0-836de3f8bdf232d21e40a920a59e5c371f215b14a82fdaa2ae5225a1eaf8db98',
          'https://static.coze.site/1523302220958247_0-drive/221124540266223586/02-B1%20High%20Density%20-5_1788755764576_0_phxt.jpg?sign=1791261388-255563debf-0-3237f6a5148cb3c5f34fd9c187211315fcc62eda9b4f6176b34f81f5932a171e',
        ],
      },
  ...
  },
  {
    ...
    products: [
      ...
      { id: 'v-7', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'low-power-8w-direct', images: ['/images/10-8w-direct-01.png'], metaTitle: '8W Low Power Direct-Acting Solenoid Valve | Refrigeration', metaDescription: '8W low power direct-acting solenoid valve, diaphragm NC, 1/4\"–3/8\", Kv 0.2–0.27, MWP 45 bar. Energy efficient. MOQ 1 pc.', name: '8W Low Power Direct-Acting Solenoid Valve — Diaphragm, NC (10 Series)', shortDesc: 'An energy-efficient direct-acting solenoid valve with only 8W power consumption, the 10 Series (Direct) covers port sizes from 1/4\" to 3/8\". Its low power design reduces heat generation and extends coil life, making it ideal for continuous-operation refrigeration systems.', description: '• Direct-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• Ultra-low 8W power consumption reduces heat generation and energy costs.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      ...
      { id: 'v-8', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'low-power-8w-servo', images: ['/images/10-8w-servo-01.png'], metaTitle: '8W Low Power Servo-Operated Solenoid Valve | Refrigeration', metaDescription: '8W low power servo-operated solenoid valve, diaphragm NC, 1/2\"–1-1/8\", Kv 0.5–4.5, MWP 45 bar. Energy efficient. MOQ 1 pc.', name: '8W Low Power Servo-Operated Solenoid Valve — Diaphragm, NC (10 Series)', shortDesc: 'The servo-operated variant of the 8W low power solenoid valve, covering larger port sizes from 1/2\" to 1-1/8\" with Kv values up to 4.5 m³/h. Combines energy efficiency with higher flow capacity for medium-capacity refrigeration systems.', description: '• Servo-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• Ultra-low 8W power consumption reduces heat generation and energy costs.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      "Ultra-low 8W power consumption for energy efficiency",
      "Servo-operated design for higher flow capacity",
      "Reduced heat generation extends coil service life",
      "Various AC and DC voltage options available",
