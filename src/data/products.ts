...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: 'v-4', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'clamping-type-large-port', images: ['/images/hv-clamping-large-01.png'], metaTitle: 'Clamping Type Solenoid Valve, 3/8"-1-1/8" | Refrigeration', metaDescription: 'Large port clamping solenoid valve, diaphragm NC, 3/8\"–1-1/8\", Kv 0.8–10, MWP 45 bar, wide voltage AC/DC. 14 models. MOQ 1 pc.', name: 'Clamping Type Solenoid Valve — Large Port, Diaphragm, NC (HV Series)', shortDesc: 'The large-port variant of the clamping-type solenoid valve, covering port sizes from 1/2\" to 1-1/8\" with Kv values up to 4.5 m³/h. Shares the same tool-free clamping coil design as the small-port version, making it ideal for medium-capacity refrigeration and air conditioning systems.', description: '• Direct-operated or servo-operated solenoid valve designed for one-way flow control.\n• Used on liquid lines, suction lines, and hot gas lines in refrigeration, cold storage, and air conditioning units.\n• Precision-engineered valve seat and seals deliver excellent sealing performance.\n• Compatible with coils of various voltages for flexible electrical configuration.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      "NC (Normally Closed) type available",
      "Various port sizes available to suit different system requirements",
      "Coils of various power supply options available for selection",
      "9W solenoid coil with MOPD up to 3.1 MPa",
      ...
      { id: 'v-5', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'ip65-direct-operated', images: ['/images/sv-ip65-direct-01.png'], metaTitle: 'IP65 Sealed Solenoid Valve, Direct Operated | Refrigeration', metaDescription: 'Direct operated NC solenoid valve with IP65 sealed coil, diaphragm, 1/4\"–3/8\", Kv 0.2–0.27, zero min pressure differential. MOQ 1 pc.', name: 'IP65 Direct-Acting Solenoid Valve — Diaphragm, NC (SV Series)', shortDesc: 'A compact direct-acting solenoid valve with IP65 protection rating, the SV Series (Direct) covers port sizes from 1/4\" to 3/8\". Its direct-acting design ensures reliable operation even at zero pressure differential, making it suitable for small-capacity refrigeration systems.', description: '• Direct-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• IP65 protection rating ensures reliable operation in humid and dusty environments.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      ...
      { id: 'v-6', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'ip65-servo-operated', images: ['/images/sv-ip65-servo-01.png'], metaTitle: 'IP65 Sealed Solenoid Valve, Servo Operated | Refrigeration', metaDescription: 'Servo NC solenoid valve with IP65 sealed coil, diaphragm, 3/8\"–7/8\", Kv 0.8–5.7, MWP 45 bar, maintenance-free. 9 models. MOQ 1 pc.', name: 'IP65 Servo-Operated Solenoid Valve — Diaphragm, NC (SV Series)', shortDesc: 'The servo-operated variant of the IP65 solenoid valve, covering larger port sizes from 1/2\" to 1-1/8\" with Kv values up to 4.5 m³/h. Ideal for medium-capacity refrigeration systems requiring higher flow rates.', description: '• Servo-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• IP65 protection rating ensures reliable operation in humid and dusty environments.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      "IP65 protection rating for harsh environment operation",
      ...
      { id: 'v-7', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'low-power-8w-direct', images: ['/images/10-8w-direct-01.jpg'], metaTitle: 'Low Power Solenoid Valve 8W, Direct Operated | Refrigeration', metaDescription: 'Direct operated NC solenoid valve, 8W low power open coil, diaphragm, 1/4\"–3/8\", Kv 0.2–0.27, MWP 45 bar. Energy-efficient. MOQ 1 pc.', name: '8W Low Power Direct-Acting Solenoid Valve — Diaphragm, NC (10 Series)', shortDesc: 'An energy-efficient direct-acting solenoid valve with only 8W power consumption, the 10 Series (Direct) covers port sizes from 1/4\" to 3/8\". Its low power design reduces heat generation and extends coil life, making it ideal for continuous-operation refrigeration systems.', description: '• Direct-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• Ultra-low 8W power consumption reduces heat generation and energy costs.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      ...
      { id: 'v-8', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'low-power-8w-servo', images: ['/images/10-8w-servo-01.jpg'], metaTitle: 'Low Power Solenoid Valve 8W, Servo Operated | Refrigeration', metaDescription: 'Servo NC solenoid valve, 8W low power open coil, diaphragm, 3/8\"–3/4\", Kv 0.8–2.6, MWP 45 bar, energy-efficient. 8 models. MOQ 1 pc.', name: '8W Low Power Servo-Operated Solenoid Valve — Diaphragm, NC (10 Series)', shortDesc: 'The servo-operated variant of the 8W low power solenoid valve, covering larger port sizes from 1/2\" to 1-1/8\" with Kv values up to 4.5 m³/h. Combines energy efficiency with higher flow capacity for medium-capacity refrigeration systems.', description: '• Servo-operated solenoid valve designed for one-way flow control in refrigeration and air conditioning systems.\n• Ultra-low 8W power consumption reduces heat generation and energy costs.\n• Suitable for installation on liquid lines, suction lines, and hot gas lines.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      "Ultra-low 8W power consumption for energy efficiency",
      "Servo-operated design for higher flow capacity",
      "Reduced heat generation extends coil service life",
      "Various AC and DC voltage options available",
      ...
      { id: 'v-10', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'normally-open-large-port', images: ['/images/hvk-no-large-01.png'], metaTitle: 'Normally Open Solenoid Valve, 1/2"-1-1/8" | Refrigeration', metaDescription: 'Large port normally open (NO) solenoid valve, diaphragm, 1/2\"–1-1/8\", Kv 0.8–10, MWP 45 bar, fail-safe open. 12 models. MOQ 1 pc.', name: 'Normally Open Solenoid Valve — Large Port, Diaphragm (HVK Series)', shortDesc: 'The large-port variant of the normally open solenoid valve, covering port sizes from 1/2\" to 1-1/8\" with Kv values up to 4.5 m³/h. Ideal for medium-capacity refrigeration systems requiring fail-open safety configuration.', description: '• Direct-operated normally open solenoid valve designed for one-way flow control.\n• Remains open when de-energized, closes when powered — ideal for safety-critical applications.\n• Used on liquid lines, suction lines, and hot gas lines in refrigeration and air conditioning units.\n• Compatible with coils of various voltages for flexible electrical configuration.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
      "Normally Open (NO) configuration for safety applications",
      "Various port sizes available to suit different system requirements",
      "Coils of various power supply options available for selection",
      "9W solenoid coil with MOPD up to 3.1 MPa",
      ...
      { id: 'v-13', categoryId: 'valves', subCategoryId: 'solenoid-valves', thirdCategoryId: 'hot-gas-defrost-3-way', images: ['/images/hvs-hot-gas-01.png'], metaTitle: 'Hot Gas Defrost Solenoid Valve, 3-Way | Refrigeration', metaDescription: '3-way hot gas defrost solenoid valve, piston servo NC, MWP 30 bar, dual Kv, −35°C~+105°C. Switches cooling/defrost modes. MOQ 1 pc.', name: 'Hot Gas Defrost Solenoid Valve — Piston, NC, Brazed ODF (HVS Series)', shortDesc: 'A specialized solenoid valve designed for hot gas defrost applications in refrigeration systems, the HVS Series features a piston structure and brazed ODF connection. With models covering port sizes from 1/2\" to 1-5/8\", it enables efficient defrost cycles in cold storage and commercial refrigeration systems.', description: '• Servo-operated solenoid valve specifically designed for hot gas defrost in refrigeration systems.\n• Enables efficient defrost cycles by redirecting hot discharge gas to the evaporator.\n• Suitable for installation on hot gas defrost lines in cold storage and commercial refrigeration.\n• Compatible with coils of various voltages through a universal valve body design.\n• Available as a complete assembly or as split supply (valve body and coil supplied separately).', features: [
    ...
    products: [
      {
        ...
        keywords: 'brazing torch for refrigeration | heavy duty hose torch MAPP gas | piezoelectric auto ignition brazing torch | HVAC brazing torch 40mm pipe | brazing torch kit CGA 600 | gas torch for copper pipe brazing | MAPP gas torch 1.5m hose brass nozzle | propane blowtorch for HVAC service | heavy duty brazing torch 1350°C | professional gas torch refrigeration repair',
        name: 'Heavy-Duty Hose Torch',
      ...
      },
      {
        ...
        keywords: 'direct mount brazing torch | 360° swivel tip torch | compact propane torch copper brazing | portable gas torch HVAC | MAPP gas torch no hose | handheld blowtorch for AC repair | direct mount propane torch CGA 600 | compact brazing torch 12mm pipe | swivel tip gas torch refrigeration | Bernzomatic compatible torch',
        name: 'Direct-Mount Torch (360° Swivel)',
      ...
      },
      {
        ...
        keywords: 'manual ignition brazing torch | budget propane torch HVAC | manual gas torch copper pipe brazing | cheap blowtorch for HVAC | CGA 600 manual torch | basic propane torch no battery | economical brazing torch refrigeration | hand torch for copper brazing | simple gas torch for plumbing | entry level brazing torch',
        name: 'Direct-Mount Torch (Manual)',
      ...
      },
      {
        ...
        keywords: 'dual head brazing torch | dual flame propane torch HVAC | wide flame gas torch 35mm | dual tip blowtorch for brazing | twin burner torch refrigeration | direct mount dual head torch | propane torch wide flame HVAC | double flame torch copper pipe | dual nozzle brazing torch 35mm | dual head gas torch auto ignition',
        name: 'Direct-Mount Dual-Head Torch',
      ...
      },
      {
        ...
        keywords: 'hose torch with on-torch valve | propane gas torch with hose 1.5m | single head hose brazing torch | gas torch valve control HVAC | MAPP gas torch with regulator valve | brazing torch for refrigeration service | blowtorch with hose and valve | hose type propane torch 28mm | gas welding torch for AC installation | professional hose torch with valve',
        name: 'Single-Head Hose Torch with Valve',
      ...
      },
      {
        ...
        keywords: 'dual head hose torch with valve | professional HVAC gas torch kit | dual flame hose torch 35mm | propane torch dual head 1.5m hose | dual tip blowtorch for brazing copper | MAPP gas torch dual head with valve | heavy duty hose torch dual nozzle | professional brazing torch for refrigeration | gas torch with hose valve dual head | twin flame propane torch HVAC wholesale',
        name: 'Hose Torch Dual Head',
      ...
      },
      {
        ...
        features: [
          ...
          'Round rod form for smooth, controlled rod deposition',
      ...
      },
      {
        ...
        features: [
          'Flat rod form — wider contact surface for controlled rod flow into capillary joints',
          'Self-fluxing on copper-to-copper — no additional flux required',
          'BCuP-2 / BCu93P classification — industry-standard for HVAC copper brazing',
          '1.3×3.2mm cross-section — precise rod delivery for tight-tolerance joints',
      ...
      },
      {
        ...
        features: [
          ...
          'Flat rod form — wider contact surface for controlled rod flow',
          'Self-fluxing on copper-to-copper — no additional flux required',
          'BCuP-2 / BCu93P classification — industry-standard for HVAC copper brazing',
