...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      { id: 'sg-1', categoryId: 'sight-glasses', subCategoryId: 'sgn-brazed', images: ['/images/sgn-brazed-01.png'], metaTitle: "Moisture Indicator Sight Glass, Brazed ODF | Refrigeration", metaDescription: "Brazed ODF moisture indicator sight glass for refrigeration liquid lines. Color-changing element detects moisture. 7 models, 1/4\"–1-1/8\". 45 bar MWP. MOQ 1 pc.", name: "Moisture Indicator Sight Glass — Brazed ODF (SGN Series)", shortDesc: "Brazed ODF moisture indicator sight glass for refrigeration liquid lines. Color-changing element detects moisture in HCFC/HFC systems. Available in 7 sizes from 1/4\" to 1-1/8\".", description: "• Moisture indicator sight glass with brazed ODF connection for refrigeration liquid lines\n• Color-changing moisture indicator: green = dry, yellow = wet\n• Visual monitoring of refrigerant flow, water content, and oil circulation\n• Forged copper bar body, modified PTFE seal\n• Compatible with HCFC and HFC systems", features: [
      ...
      { id: 'sg-2', categoryId: 'sight-glasses', subCategoryId: 'sgn-sae', images: ['/images/sgn-sae-01.png'], metaTitle: "Moisture Indicator Sight Glass, SAE Flare | Refrigeration", metaDescription: "SAE flare moisture indicator sight glass for refrigeration. UNF thread connection. Color-changing moisture element. 5 models, 1/4\"–3/4\". 45 bar. MOQ 1 pc.", name: "Moisture Indicator Sight Glass — SAE Flare (SGN Series)", shortDesc: "SAE flare moisture indicator sight glass with UNF thread connection. Color-changing element detects moisture in HCFC/HFC systems. Available in 5 sizes from 1/4\" to 3/4\".", description: "• Moisture indicator sight glass with SAE flare (UNF) connection for refrigeration liquid lines\n• Color-changing moisture indicator: green = dry, yellow = wet\n• Visual monitoring of refrigerant flow, water content, and oil circulation\n• Forged copper bar body, modified PTFE seal\n• Compatible with HCFC and HFC systems", features: [
        "Modified PTFE seal material compatible with various refrigerants and oils",
        "Explosion-proof structure with clear, safe observation window",
        "Forged from high-quality copper bar—high strength and good plasticity",
      ...
      { id: 'sg-3', categoryId: 'sight-glasses', subCategoryId: 'sgn-sae-mf', images: ['/images/sgn-sae-mf-01.png'], metaTitle: "Moisture Indicator Sight Glass, SAE Flare M/F | Refrigeration", metaDescription: "Male/female SAE flare sight glass with moisture indicator. Dual-end flare for direct tube connection. 4 models, 1/4\"–5/8\". UNF threads. 45 bar. MOQ 1 pc.", name: "Moisture Indicator Sight Glass — SAE Flare, Male/Female (SGN-MF Series)", shortDesc: "Male/female dual-end SAE flare sight glass with built-in moisture indicator. One male and one female flare end enable direct tube-to-tube connection without additional fittings. Available in 4 sizes from 1/4\" to 5/8\".", description: "• Male/female dual-end SAE flare sight glass for refrigeration liquid lines\n• One male and one female flare end enable direct tube-to-tube connection without additional fittings\n• Color-changing moisture indicator: green = dry, yellow = wet\n• Visual monitoring of refrigerant flow, water content, and oil circulation\n• Forged copper bar body, modified PTFE seal\n• Compatible with HCFC and HFC systems", features: [
        "Modified PTFE seal material compatible with various refrigerants and oils",
        "Explosion-proof structure with clear, safe observation window",
        "Forged from high-quality copper bar—high strength and good plasticity",
