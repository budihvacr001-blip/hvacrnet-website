...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subCategories: [
      {
        id: 'dry-filters',
        name: 'Dry Filters / Filter Driers',
        subCategories: [
