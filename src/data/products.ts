...
export const categories: Category[] = [
  {
    ...
    products: [

      {
        ...
        name: 'ACR Soft Copper Mini Jumbo Coil for HVAC Refrigeration Systems',
        shortDesc: 'Level-wound soft copper mini jumbo coil for residential and light commercial AC installation. Compact size, easy handling. O60 annealed, ASTM B280. Low MOQ, ready to ship.',
        description: 'ACR soft copper mini jumbo coil is designed for residential and light commercial AC installation where compact size and easy handling are priorities. Made from C12200 (TP2) phosphorus-deoxidized copper, our mini jumbo coils comply with ASTM B280 and EN 12735-1 standards.\n\nThe level-wound format allows smooth, tangle-free dispensing during installation, while the O60 soft annealed temper ensures easy bending and flaring on-site. Each coil is 100% eddy current tested and supplied with a Mill Test Certificate (EN 10204 3.1).',
        images: [
        ...
        features: [
          ...
          'Compact size for easy handling and transport',
        ...
        applications: 'Residential split AC, light commercial refrigeration, heat pump systems, small VRF/VRV',
        materialStandard: [
          ...
          { label: 'Length', value: '30M / 50M (custom lengths available)' },
          { label: 'Inner Surface', value: 'Bright, clean, oxidation-free' },
          { label: 'Testing', value: '100% eddy current tested, air tightness test, flattening test, flaring test' },
          { label: 'Certificate', value: 'MTC (EN 10204 3.1) with each shipment' },
        ],
        specs: [
          { label: 'Outer Diameter', value: '1/4" (6mm), 3/8" (10mm), 1/2" (12mm), 5/8" (16mm), 3/4" (19mm), 7/8" (22mm), 1" (25.4mm), 1-1/8" (28mm)' },
          { label: 'Wall Thickness', value: '0.6mm, 0.7mm, 0.8mm, 0.9mm, 1.0mm' },
          { label: 'Coil Length', value: '30M, 50M (custom lengths available)' },
          { label: 'Coil Weight', value: 'Varies by OD and wall thickness' },
          { label: 'Packaging', value: 'Standard export carton with end caps' },
        ],
      },
      {
        id: 'ct-1',
